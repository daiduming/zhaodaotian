var t = getApp(), a = t.requirejs("core"), e = t.requirejs("biz/order_zs");
...
Page({
  ...
  cancel: function (t) {
    ...
    e.cancel(s, t.detail.value, "/pages/order_zs/index?status=" + this.data.status);
  },
  delete: function (t) {
    var s = a.data(t).type, i = a.data(t).orderid;
    e.delete(i, s, "/pages/order_zs/index", this);
  },
  finish: function (t) {
    a.data(t).type;
    var s = a.data(t).orderid;
    e.finish(s, "/pages/order_zs/index");
  },
