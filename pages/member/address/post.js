        ...
        e.get("member/address/get_detail", {
          ...
          console.log(e);
            ...
            if (!i.isEmptyObject(e.detail)) {
              ...
              a.pval = s, a.pvalOld = s, a.detail = e.detail, a.isdefault = e.detail.isdefault;
            }
      ...
      r.isdefault = i.data.isdefault;
        ...
        i.setData({
            ...
            i.setData({
                ...
                r.id = s.addressid;
                if ("member" == i.data.type){
                  wx.navigateBack();
                  return false;
                } 
                "quickaddress" == i.data.type ? (t.setCache("orderAddress", r, 30), 
