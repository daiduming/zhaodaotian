...
Page({
  ...
  getBanner: function(){
    var that = this;
    core.get("activity/get_banner", {}, function (e) {
      console.log(e);
      that.setData({
        imgUrls: e.list
      });
  ...
  getRecommend: function () {
    var that = this;
    core.get("activity/get_Recommend", {}, function (e) {
      that.setData({
  ...
  getCategory: function () {
    var that = this;
    core.get("activity/get_Category", {}, function (e) {
      that.setData({
        categoryList: e.list,
        cateCurrent: e.list[0].id
      });
      that.getList();
    });
  },
  ...
  getList: function () {
    ...
    if (!data.keywords){
      data.cate = that.data.cateCurrent
    }
    core.get("activity/get_List", data, function (e) {
      if (0 == e.error){
        that.setData({
          loaded: !1,
          show: !0,
